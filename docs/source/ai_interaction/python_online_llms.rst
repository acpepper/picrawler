...
17. Connecting to Online LLMs
================================

In this lesson, we'll learn how to connect your PiCrawler (or Raspberry Pi) to different **online Large Language Models (LLMs)**.  
...
#. In your project folder (for example: ``/picrawler/examples``), create a file called ``secret.py``:
